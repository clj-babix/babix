...
{:name "ripgrep-14.1.0"
 ...
 ;; (See the "Decisions from RFC Review (2026)" section in
 ;; [docs/CONTEXT.md](docs/CONTEXT.md) for the rationale.)
 :advisories
 [{:kind "deprecated"
